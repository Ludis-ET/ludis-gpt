      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <button
            ...
            onClick={() => setSide(!side)}
            type="button"
            className="inline-flex items-center p-2 mb-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          >
            <span className="sr-only">Open sidebar</span>
            <svg
              className="w-6 h-6"
          ...
          <ul className="space-y-2 font-medium overflow-y-scroll min-h-[18vw]">
            <li>
              <a
                href="#"
